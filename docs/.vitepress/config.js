    ...
    sidebar: [
      {
        ...
        items: [
          ...
          {
            text: "看一遍就会的setup语法糖",
            link: "/vue/看一遍就会的setup语法糖",
          },
          {
            text: "vue的生命周期都做了什么",
            link: "/vue/简述生命周期以及每个阶段做的事",
          },
          { text: "vue项目打包优化", link: "/vue/vue项目打包优化" },
          {
            text: "setup中如何定义组件的name属性",
            link: "/vue/setup中如何定义组件的name属性",
          },
          {
            text: "vue_ts中配置eslint_prettier",
            link: "/vue/vue_ts中配置eslint_prettier",
          },
          { text: "vue批量导入文件", link: "/vue/vue批量导入文件" },
          {
            text: "unplugin-auto-import自动导入组合api",
            link: "/vue/unplugin-auto-import自动导入组合api",
          },
          {
            text: "vite打包配置(gzip、文件分类等)",
            link: "/vue/vite打包配置(gzip、文件分类等)",
          },
          { text: "h5兼容低版本浏览器", link: "/vue/h5兼容低版本浏览器" },
          // { text: "开箱即用的中后台管理模版", link: "/vue/开箱即用的中后台管理模版" },
          {
            text: "Composition API_常用部分",
            link: "/vue/Composition API_常用部分",
          },
          {
            text: "Composition API_其它部分",
            link: "/vue/Composition API_其它部分",
          },
          ...
          { text: "vue播放视频动效", link: "/vue/vue播放视频动效" },
        ],
      },
      {
        text: "typescript",
        ...
        items: [
          ...
          {
            text: "Typescript中的常用高级类型",
            link: "/typescript/Typescript中的常用高级类型.md",
          },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "开发中碰到的问题集合(碰到的坑)",
            link: "/interview/开发中碰到的问题集合",
          },
        ],
      },
    ],
