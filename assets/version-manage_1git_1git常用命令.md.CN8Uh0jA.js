import{_ as s,c as i,o as a,ac as n}from"./chunks/framework.DfhY12bu.js";const y=JSON.parse('{"title":"git 常用命令","description":"","frontmatter":{},"headers":[],"relativePath":"version-manage/1git/1git常用命令.md","filePath":"version-manage/1git/1git常用命令.md"}'),l={name:"version-manage/1git/1git常用命令.md"},p=n(`<h1 id="git-常用命令" tabindex="-1"><a href="https://gitee.com/mao-118/utools-filebed/raw/master/git/Git-2.23.0-64-bit.exe" target="_blank" rel="noreferrer">git</a> 常用命令 <a class="header-anchor" href="#git-常用命令" aria-label="Permalink to &quot;[git](https://gitee.com/mao-118/utools-filebed/raw/master/git/Git-2.23.0-64-bit.exe) 常用命令&quot;">​</a></h1><h2 id="仓库" tabindex="-1">仓库 <a class="header-anchor" href="#仓库" aria-label="Permalink to &quot;仓库&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在当前目录新建一个Git代码库</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">git</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> archive</span></span></code></pre></div>`,21),h=[p];function t(k,e,g,r,F,d){return a(),i("div",null,h)}const E=s(l,[["render",t]]);export{y as __pageData,E as default};
