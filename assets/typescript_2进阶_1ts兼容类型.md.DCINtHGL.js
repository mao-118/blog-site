import{_ as s,c as i,o as a,ac as n}from"./chunks/framework.DfhY12bu.js";const y=JSON.parse('{"title":"TS中的兼容性","description":"","frontmatter":{},"headers":[],"relativePath":"typescript/2进阶/1ts兼容类型.md","filePath":"typescript/2进阶/1ts兼容类型.md"}'),l={name:"typescript/2进阶/1ts兼容类型.md"},p=n(`<h1 id="ts中的兼容性" tabindex="-1">TS中的兼容性 <a class="header-anchor" href="#ts中的兼容性" aria-label="Permalink to &quot;TS中的兼容性&quot;">​</a></h1><h2 id="自动类型推论" tabindex="-1">自动类型推论 <a class="header-anchor" href="#自动类型推论" aria-label="Permalink to &quot;自动类型推论&quot;">​</a></h2><ul><li><p>根据初始值进行类型推论</p><p>不用明确告诉编译器具体是什么类型, 编译器就知道是什么类型</p><p>根据初始化值自动推断</p><p><strong>注意点：</strong> 如果是先定义在初始化, 那么是无法自动推断的</p></li><li><p>上下文类型推论</p><p>TypeScript类型推论也可能按照相反的方向进行。 这被叫做“按上下文归类”。按上下文归类会发生在表达式的类型与所处的位置相关时</p></li></ul><div class="language-typescript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> */</span></span></code></pre></div>`,24),h=[p];function k(t,e,r,d,g,c){return a(),i("div",null,h)}const D=s(l,[["render",k]]);export{y as __pageData,D as default};
